...
-- keymap.set("n", "<leader>sn", "<C-w>h", { desc = "Go to next split window" })
-- keymap.set("n", "<leader>sp", "<C-w>l", { desc = "Go to previous split window" })
-- keymap.set("n", "<leader>sx", "<cmd>close<CR>", { desc = "Close current split" }) -- close current split window

-- keymap.set("n", "<leader>to", "<cmd>tabnew<CR>", { desc = "Open new tab" }) -- open new tab
-- keymap.set("n", "<leader>tx", "<cmd>tabclose<CR>", { desc mm= "Close current tab" }) -- close current tab
